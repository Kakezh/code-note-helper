...
适合希望减少坚果云流量限制影响、或在国外网络环境下使用更稳定云盘的用户。开启后，扩展会把完整备份文件保存到你自己的 Google Drive。

- 备份内容：题目记录、题单、笔记、复习状态、同步元数据。
- 数据流向：当前浏览器直接上传到你的 Google Drive，不经过开发者服务器。
- 触发方式：首次使用时点击“登录并测试”，浏览器会打开 Google 登录与授权页面；之后你可以点击“立即备份到 Google Drive”或“从 Google Drive 恢复”。
